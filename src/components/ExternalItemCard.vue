...
const bannerAssetUrl = computed(() => {
  return (store.banner_dir_url && props.item && props.item.banner_filename)
    ? store.banner_dir_url + props.item.banner_filename
...
<template>
  <div
    @click="store.home.selected_item = item" 
    ...
    <div class="px-6 pt-3 pb-4">
      ...
      <div class="flex items-center">
        ...
        <div class="shrink-0">
          <RouterLink :to="{ name: 'externalItem', params: { id: item.id } }" @click.stop class="inline-block p-2 -mb-2 -mr-2 text-blue-600">
